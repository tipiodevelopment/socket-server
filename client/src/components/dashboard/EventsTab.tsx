...
export function EventsTab({ campaignId, campaign }: EventsTabProps) {
  ...
  // Campaign logo state
  const [campaignLogo, setCampaignLogo] = useState<string>(
    campaign?.logo || 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=200&q=80'
  );
  
  // Load campaign logo when campaign data changes
  useEffect(() => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-6">
      ...
      <div className="lg:col-span-2 space-y-6">
        ...
        <p className="text-sm sm:text-base text-muted-foreground">Use the + button to add more events</p>
        
        {/* Campaign Logo Configuration */}
        <div className="bg-white/5 border-0 rounded-lg p-4">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-300">Campaign Logo</h3>
