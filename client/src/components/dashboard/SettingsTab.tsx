...
export function SettingsTab({ campaignId, campaign }: SettingsTabProps) {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      {/* Tipio Integration */}
      <div>
        <h2 className="text-sm font-semibold text-gray-400 uppercase mb-1">Tipio Integration</h2>
        <p className="text-xs text-gray-500 mb-4">API key for the Tipio commerce module integration</p>
        <div className="border border-white/10 rounded-lg p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Enter Tipio API key..."
