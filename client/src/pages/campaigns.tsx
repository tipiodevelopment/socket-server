...
import { Plus, Calendar, BarChart3, Globe, Search, Megaphone } from 'lucide-react';
          ...
          {filteredCampaigns.map((campaign) => {
            ...
            return (
              <Link key={campaign.id} href={`/campaigns/${campaign.id}`}>
                <div
                  className="flex items-start justify-between gap-4 p-4 bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-lg hover:border-gray-300 dark:hover:border-white/[0.12] transition-all cursor-pointer group"
                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2.5 mb-1">
                      ...
                      <span
                        className={`text-[10px] font-semibold tracking-wider px-2 py-0.5 rounded border ${statusCfg.className}`}
